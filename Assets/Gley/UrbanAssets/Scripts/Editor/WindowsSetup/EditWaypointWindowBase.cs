...
{
    public abstract class EditWaypointWindowBase : SetupWindowBase
    {
        ...
        protected WaypointSettingsBase selectedWaypoint;
        protected WaypointSettingsBase clickedWaypoint;
        ...
        internal abstract WaypointSettingsBase SetSelectedWaypoint();
        ...
        protected void WaypointClicked(WaypointSettingsBase clickedWaypoint, bool leftClick)
        {
            if (leftClick)
            {
