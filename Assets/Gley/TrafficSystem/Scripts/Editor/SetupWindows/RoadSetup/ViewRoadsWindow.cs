    ...
    public class ViewRoadsWindow : ViewRoadsWindowBase
    {
        ...
        public override void DrawInScene()
        {
            ...
            roadsOfInterest = roadDrawer.ShowAllRoads(MoveTools.None, roadColors.roadColor, roadColors.anchorPointColor, roadColors.controlPointColor, roadColors.textColor,
                save.viewRoadsSettings.viewLanes,save.viewRoadsSettings.viewWaypoints, save.viewRoadsSettings.viewLaneChanges, roadColors.laneColor, roadColors.waypointColor, roadColors.disconnectedColor, roadColors.laneChangeColor);
        ...
        protected override void TopPart()
        {
            ...
            if (GUILayout.Button(drawButton))
            {
                ...
                roadDrawer.SetDrawProperty(drawAllRoads);
        ...
        protected void DeleteRoad(RoadBase road)
        {
            roadDrawer.DeletRoad(road);
            roadsOfInterest.Remove(road);
