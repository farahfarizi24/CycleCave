...
namespace Gley.TrafficSystem.Editor
{
    public class DrawRoadConnectors : UnityEditor.Editor
    {
        ...
        {
            Debug.LogWarning("Road " + road.name + " is not correctly generated. Please regenerate it from Traffic System Settings -> Road Setup -> Edit ->" + road.name, road.gameObject);
        }
